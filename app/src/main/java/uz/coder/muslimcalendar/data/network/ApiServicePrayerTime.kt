...
interface ApiServicePrayerTime {
    ...
    suspend fun oneMonth(@Path("year") year:Int, @Path("month") month:Int, @Query("latitude") latitude: Double, @Query("longitude") longitude: Double, @Query("method") method:Int = 2): Response<PrayerResponse<List<PrayerData>>>
}